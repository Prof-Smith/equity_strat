...
metrics_df = pd.read_csv("charts/manager_metrics_updated.csv")

# Load updated charts with benchmark in red
alpha_chart = pio.read_json("charts/alpha_chart_red.json")
active_share_chart = pio.read_json("charts/active_share_chart_red.json")
sharpe_ratio_chart = pio.read_json("charts/sharpe_ratio_chart_red.json")
annual_return_chart = pio.read_json("charts/annualized_return_chart_red.json")
